...
Run this locally to get the refresh token for deployment.
...
Prerequisites:
    ...
    2. Set environment variables:
       ...
       - MICROSOFT_TENANT_ID (optional, defaults to 'consumers')
"""
...
def main():
    ...
    print("=" * 60)
    print("Microsoft OAuth2 Setup for Breaktime Tracker Excel Sync")
    print("=" * 60)
    print()
    ...
    if not CLIENT_ID:
        ...
        print("4. Name: 'Breaktime-Tracker-Excel-Sync'")
        ...
        print("   (Windows: set MICROSOFT_CLIENT_ID=your-client-id)")
        return
    ...
    if not CLIENT_SECRET:
        ...
        print("   (Windows: set MICROSOFT_CLIENT_SECRET=your-secret)")
        return
    ...
    if 'access_token' in result:
        print()
        print("=" * 60)
        print("SUCCESS! Copy these values to your .env file or deployment:")
        print("=" * 60)
        print()
        ...
        print("=" * 60)
        print()
        print("Also set these in your configuration:")
