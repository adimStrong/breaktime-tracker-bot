...
Production-ready with daily database archiving
"""
import os
import pandas as pd
...
# Bot Configuration
BOT_TOKEN = "8417145929:AAGW8uDSrK_VrRN4NIadLf9bOwcTXWabgEo"  # Replace with your bot token from @BotFather
BASE_DIR = "C:/Users/us/Desktop/breaktime_tracker_bot"
...
def log_break_activity(user_id, username, full_name, break_type, action, timestamp, duration=None, reason=None):
    """Log break activity to daily Excel file"""
    log_file = get_daily_log_file()
